...
public class Plotter2211 : MonoBehaviour {
...
public void ShowBarchartInverted1 () {
//void Start(){
...
// Assign column name from columnList to Name variables
 ...
 for (var i = 0; i < pointList.Count; i++)
    ...
    GameObject dataBar = Instantiate(BoxPrefab, new Vector3(height/2,i*scaleXZ, 0), Quaternion.identity);
